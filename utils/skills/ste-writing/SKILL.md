...
```
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ste-writing/scripts/ste-lint.py draft.md            # flavored target: under 2.5 per 100 words
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ste-writing/scripts/ste-lint.py --strict draft.md   # strict target: under 1.5 per 100 words
```
