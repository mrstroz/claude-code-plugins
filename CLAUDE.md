...
- Most JIRA skills depend on MCP tools (`createJiraIssue`, `searchJiraIssues`, etc.) at runtime; `jira-fetch` bypasses MCP and calls JIRA REST API v3 directly via a bundled Node.js script
