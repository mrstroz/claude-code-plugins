...
| Task |   | Title | Summary |
|------|---|-------|---------|
| [PROJ-123](https://{cloudBaseUrl}/browse/PROJ-123) | A | Fix payment timeout | 2.1.0 · 🔵 In Progress · Jan — Blocker since yesterday — Anna and Piotr on QA are blocked on checkout testing, waiting for your hotfix. Deploy to staging so QA can resume. |
...
| Summary | Metadata prefix + situation + proposed action | `{Ver} · {Status} · {Assignee} — {summary text}` (~30-50 words for the summary text; see writing rules below) |

---

## Summary Column Writing Rules

The Summary column is the most valuable part of the table — it tells the user what is happening and what to do next. Each Summary cell starts with a metadata prefix followed by the narrative summary:

**`{Ver} · {Status} · {Assignee} — {situation with actors}. {proposed action}.`**
...
The narrative portion follows this structure:
...
|-------------|---------------|---------|
| Action Needed | Blocker priority, 2 comments asking for fix, QA team mentioned | 4.2.0 · 🔵 In Progress · Mariusz — Blocker since yesterday — Anna and Piotr on the QA team are blocked on checkout regression testing, waiting for your hotfix. Deploy fix branch to staging so QA can resume. |
| Action Needed | Comment: "@me can you review the rate limit config?" | 4.2.0 · 🔵 In Review · Mariusz — Maria asked you to review the rate limit config changes 2h ago in comments. She needs your sign-off before merging to main. Review and respond. |
| Ready to Proceed | Status: In Review, code review approved | 4.2.0 · 🔵 In Review · Mariusz — Jan approved your code review on the mobile optimization PR. No blockers remain. Merge to main and deploy to staging. |
| Ready to Proceed | Status: Done in QA, bug fix verified | 4.2.0 · 🟢 Done · Mariusz — Anna verified the CSV date formatting fix in QA — all test cases pass. Move to Done and schedule for next production deploy. |
| Info | Comment: "@jan can you review this", task not assigned to me | 4.2.0 · 🔵 In Progress · Jan — Maria asked Jan to review the search indexing changes. Not directed at you — Jan is the reviewer. No action needed. |
| Info | Teammate pushed UI fixes, normal progress | 4.2.0 · 🔵 In Progress · Maria — Maria pushed storefront UI fixes for the product grid layout. On track for 4.2.0 release, no action needed from you. |
| Info | Task assigned to me, outside my domain | — · ⚪ Open · Mariusz — PCI compliance review assigned to you but Anna on the security team has more context. Consider reassigning to Anna. |
